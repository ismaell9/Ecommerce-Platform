...
function OrdersTab() {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      ...
      <Link to="/profile/orders" className="text-primary-600 hover:text-primary-700 text-sm">
...
function WishlistTab() {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <h2 className="text-lg font-semibold text-gray-900 mb-6">Wishlist</h2>
      <Link to="/wishlist" className="text-primary-600 hover:text-primary-700 text-sm">
        View wishlist &rarr;
      </Link>
    </div>
  )
